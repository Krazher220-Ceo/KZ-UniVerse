...
const features = [
  ...
  },
  {
    ...
    description: 'Выбор зависит от ваших приоритетов - престиж, стоимость, локация или специализация. Заполните приоритеты в профиле, и AI будет учитывать их при рекомендациях',
